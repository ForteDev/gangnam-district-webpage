import {Slider, Swiper} from './Swiper.js';
...
const categorySwiper1 = new Slider(document.querySelector("#main-info .announcement .category-swiper01 .category-swiper"));
...
const citizenSwiper = new Slider(document.querySelector("#main-info .info-board-top .with-citizen .swiper"));
...
citizenSwiper.setAutoSlide(5000);
